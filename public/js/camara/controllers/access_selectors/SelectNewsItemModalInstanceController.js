(function() {
   ...
   function SelectNewsItemModalInstanceController( $scope, Utils,
      ...
      var _update = function() {
         ...
         //BEGIN - getNews
         var __getNews = function(filter) {
            return NewsService.getNews({ page: $modalCtrl.pager.page,
         ...
         if(Utils.isMongoId($modalCtrl.keywords)) {
            ...
            __getNews({ id: $modalCtrl.keywords, //try searching by id
            ...
            __getNews({ keywords: $modalCtrl.keywords,
                        publication: "PUBLISHED" })
               .then(function(result) {
                  __handleResult(result);
               }).catch(function(error) {
